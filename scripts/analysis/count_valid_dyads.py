...
def main():
    ...
    intra_path = dppa_dir / "intra_family" / "intra_family_icd_task-therapy_method-sliding_duration30s_step5s.csv"
    inter_path = dppa_dir / "inter_session" / "inter_session_icd_task-therapy_method-nsplit120.csv"

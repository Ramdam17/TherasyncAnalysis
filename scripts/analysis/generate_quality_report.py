...
def generate_markdown_report(issues: List[Dict], output_path: Path):
    ...
    if not issues:
        ...
        report += "✅ **No quality issues detected** - all metrics within expected ranges.\n"
    ...
    report += "   - ✅ **Include**: If artifacts are minor or physiologically plausible\n"
    report += "   - ❌ **Exclude**: If signal quality is too poor for reliable analysis\n"

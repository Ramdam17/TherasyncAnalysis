...
def get_physio_duration(subject: str, session: str, data_root: Path) -> Dict[str, float]:
...
def check_all_sessions(data_root: Path) -> List[Dict]:
    ...
    moi_files = list(sourcedata_dir.glob("sub-*shared/ses-*/moi_tables/*_desc-alliance_annotations.tsv"))

...
Examples:
  ...
  python scripts/preprocess_bvp.py --subject sub-f01p01 --session ses-01 --config custom_config.yaml
  ...
  python scripts/preprocess_bvp.py --batch --subject-pattern "sub-f01*"
        """
    )

...
def main():
    ...
    bvp_cleaner_doc = document_class('src.physio.preprocessing.bvp_cleaner', 'BVPCleaner')
    print(f"  ✓ BVPCleaner")
    
    bvp_metrics_doc = document_class('src.physio.preprocessing.bvp_metrics', 'BVPMetricsExtractor')
    print(f"  ✓ BVPMetricsExtractor")
    
    bvp_writer_doc = document_class('src.physio.preprocessing.bvp_bids_writer', 'BVPBIDSWriter')
    print(f"  ✓ BVPBIDSWriter")
    ...
    eda_cleaner_doc = document_class('src.physio.preprocessing.eda_cleaner', 'EDACleaner')
    print(f"  ✓ EDACleaner")
    
    eda_metrics_doc = document_class('src.physio.preprocessing.eda_metrics', 'EDAMetricsExtractor')
    print(f"  ✓ EDAMetricsExtractor")
    
    eda_writer_doc = document_class('src.physio.preprocessing.eda_bids_writer', 'EDABIDSWriter')
    print(f"  ✓ EDABIDSWriter")

...
class TestAllianceICDLoader:
    ...
    def loader(self, mock_config):
        ...
        with patch.object(AllianceICDLoader, '__init__', lambda self, config_path=None: None):
...
class TestAllianceICDAnalyzer:
    ...
    def sample_data(self):
        ...
        for state, label in [(0, 'neutral'), (1, 'positive'), (-1, 'negative'), (2, 'split')]:
    ...
    def analyzer(self):
        ...
        with patch.object(AllianceICDAnalyzer, '__init__', lambda self, config_path=None: None):
            analyzer = AllianceICDAnalyzer()
            analyzer.loader = Mock()
            analyzer._data = None
            analyzer.ALLIANCE_LABELS = {0: 'Neutral', 1: 'Positive', -1: 'Negative', 2: 'Split'}
            return analyzer
